...
import org.vben.config.JeecgBaseConfig;
import org.vben.config.shiro.filters.CustomShiroFilterFactoryBean;
import org.vben.config.shiro.filters.JwtFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
        filterChainDefinitionMap.put("/salary","anon");
        filterChainDefinitionMap.put("/salary/**","anon");
        filterChainDefinitionMap.put("/bx","anon");
        filterChainDefinitionMap.put("/bx/**","anon");
        filterChainDefinitionMap.put("/sys/smsGz/getSmsGzNew","anon");
        filterChainDefinitionMap.put("/sys/smsGz/getSmsGzNewDetail","anon");
