...
public class TokenUtils {
    ...
    /**
     * 获取 request 里传递的 accountSuitId (租户ID)
     *
     * @param request
     * @return
     */
    public static String getAccountSuitIdByRequest(HttpServletRequest request) {
        String accountSuitId = request.getParameter(TenantConstant.ACCOUNT_SUIT_ID);
        if (accountSuitId == null) {
            accountSuitId = oConvertUtils.getString(request.getHeader(CommonConstant.ACCOUNT_SUIT_ID));
        }
        return accountSuitId;
    }
