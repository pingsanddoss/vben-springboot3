package org.vben.common.constant;
...
public interface CommonConstant {
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:org.vben.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
...
//    int  TOKEN_EXPIRE_TIME  = 3600;
    ...
    */
    ...
    String ACCOUNT_SUIT_ID = "X-AccountSuit-Id";
